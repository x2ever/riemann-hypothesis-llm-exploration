...
**[→ Start with the anchor post: 6 things this AI did that we did not expect](posts/00-anchor-honest-failure/)**
...
Contact: **x2ever.han@gmail.com** · [한국어](../ko/) · [GitHub repo](https://github.com/x2ever/riemann-hypothesis-llm-exploration)
...
- **🔢 Numerical evidence** — `mpmath` sanity-checks against published RH-equivalent formulas (Voros, Lagarias, Mertens, Wigner GUE, Hilbert–Pólya).
- **🛠 Process** — the 4-phase research cycle, external critique loop, intuition-calibration data.
...
1. **The anchor post**: [6 things this AI did that we did not expect](posts/00-anchor-honest-failure/) — concrete moments, paper-direct quotes, the 50-row Python table.
2. **What this project does *not* claim**: [Honest scope](posts/09-honest-scope/) — explicit list of disclaimers.
3. **The 11/11 universal NO audit**: [Lemma 9](posts/12-lemma-axiom6-ceiling/) — the most concrete artifact.

## Found this through a hot-take title?

If you were expecting "AI proves the Riemann Hypothesis": that's not what this is. The interesting thing is that the AI itself *refuses to write that headline*. Read [Honest Scope](posts/09-honest-scope/) for the explicit list of claims this project does *not* make. Read [the anchor post](posts/00-anchor-honest-failure/) for what it *does* do.
