...
- Cycle protocol post (mechanics): [The 4-phase research cycle protocol](../06-process-cycle-protocol/)
- External critique loop: [Six external critiques absorbed](../07-process-critique-loop/)
- Reporter flag on the cycle protocol's own publication ambitions: [Cycle Protocol over-claim flag](../11-reporter-flag-cycle-protocol-overclaim/)
- The previous reporter update (Cycles 8–11): [Project splits into two preprint tracks](../10-update-cycles-8-11/)
...
[← Previous: Reporter flag on cycle protocol over-claim](../11-reporter-flag-cycle-protocol-overclaim/) · [한국어](../../../ko/posts/19-update-cycles-17-20/) · [All English posts](../../)
